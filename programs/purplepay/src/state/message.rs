    ...
    fn serialize<W: io::Write>(&self, writer: &mut W) -> io::Result<()> {
        match self {
            ...
            HelloWorldMessage::Hello { message } => {
                ...
                if len > HELLO_MESSAGE_MAX_LENGTH {
                    Err(
                        io::Error::new(
                    ...
                    //TODO : solabi encode directly maybe?
                    //TODO : Edit, what and how ?
                    // PAYLOAD_ID_HELLO.serialize(writer)?;
                    // (len as u16).to_be_bytes().serialize(writer)?;
                    // for item in message {
